      ...
      <div className="h-full w-full bg-yellow-100">
        <div className="p-4 relative h-full flex flex-col justify-start items-center">
          <motion.div
            ...
            animate={animateTo}
            exit={exitTo}
            className="m-4 relative rounded top-[5%] z-10 w-full sm:w-[95%] md:w-[65%] lg:w-[45%] xl:w-[35%] lg:min-h-[60%] p-4 py-6 shadow-lg bg-white flex flex-col lg:justify-center gap-2"
          >
